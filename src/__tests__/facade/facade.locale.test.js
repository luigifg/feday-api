...
const facade = require("../../facade/locale")
...
describe("Testes do banco de dados", () => {
  ...
  test("SEARCH AND", async () => {
    ...
    const params = [
      { column: "name", signal: "=", value: "Nome", operator: "AND" },
    ]
    result = await facade.search(params)
  ...
  test("SEARCH OR", async () => {
    ...
    const params = [
      { column: "name", signal: "=", value: "Nome", operator: "OR" },
    ]
    result = await facade.search(params)
  ...
  test("SEARCH LIKE", async () => {
    ...
    const params = [
      { column: "name", signal: "=", value: "Nome", operator: "LIKE" },
    ]
    result = await facade.search(params)
