...
const facade = require("../../facade/screen")
...
describe("Testes do banco de dados", () => {
  ...
  test("INSERT + UPDATE", async () => {
    ...
    expect(resultGet2).toHaveProperty("name", "Nome Teste")
  ...
  test("INSERT + UPDATE INCORRETO", async () => {
    ...
    console.log(result)
    expect(result).toEqual({
      errors: ['"order" is required', '"TESTE" is not allowed'],
    })
  })
